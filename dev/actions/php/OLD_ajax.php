...
//
// 	$graph_id = json_decode($post['graphID']);
// 	$graph_identifier = $post['Name'];
//
// 	$occurrence_ids = json_decode($post['occurrenceIDs']);
//
// 	assert($occurrence_ids);
...
// 	} else {
// 		$graph = new Graph( $graph_identifier, $ps->getActiveProject() );
// 	}
//
// 	foreach( $occurrence_ids as $occurrence_id) {
// 		$lemma->assignOccurrenceID($occurrence_id); //existing graph assignment is deleted!
// 	}
//
// }
