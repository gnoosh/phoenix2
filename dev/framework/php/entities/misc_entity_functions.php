...
/*/
{
	...
	$text_descriptors = $text->getTextDescriptors( array('d0', 'rd0', 'scripta') );
	// write meta section
	...
	$occ_matches_meta[] = array('zitfFull' => $zitf_full, 'zitfShort' => $zitf_short, 'd0' => $d0, 'd0Full' => $d0_full, 'rd0Full' => $rd0_full, 'rd0Short' => $rd0_short, 'rd0Full' => $rd0_full, 'scripta' => $scripta, 'divID' => $occ->getDiv(), 'occurrenceID' => $occ_id, 'textID' => $text->getID(), 'order' => $occ->getOrder(), 'lemma' => $lemma_string, 'lemma_pos' => $lemma_morph_string);
